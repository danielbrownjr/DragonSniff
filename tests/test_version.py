...
class VersionContractTests(TestCase):
    def test_source_tree_exports_release_version(self) -> None:
        self.assertEqual(dragonsniff.__version__, "0.3.0")
    ...
    def test_http_identifiers_use_the_release_version(self) -> None:
        ...
        self.assertEqual(request.get_header("User-agent"), "DragonSniff/0.3.0")
        self.assertEqual(DragonSniffHandler.server_version, "DragonSniff/0.3.0")
